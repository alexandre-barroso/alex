#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Convert Kaldi CTM output to IPA-normalized Praat TextGrid files."""
...
def main(args):
    ...
    for uttid in g_ctm["uttid"].unique():
        try:
            ...
            # build phonemes tier
            logging.info(f"building 'fonemas-ipa' tier...")
            ...
            logging.info(f"building 'silabas-fonemas-ipa' tier...")
            ...
            logging.info(f"building 'frase-fonemas-ipa' tier...")
            ...
            ps_tier.add(minTime=bos, maxTime=eos, mark=clean_textgrid_mark(t))
